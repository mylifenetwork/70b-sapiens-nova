...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="w-full bg-[var(--bg-sage)] text-black py-16 md:py-24 relative overflow-hidden min-h-[600px]"
    >
      <div className="container-large px-6 relative z-10 space-y-12">
                ...
                <li key={href}>
                  {href.startsWith("http") ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-gray-700 hover:text-black transition-colors text-sm md:text-base font-sans"
                    >
                      {label}
                    </a>
                  ) : (
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <a
                  ...
                  className="text-gray-700 hover:text-black transition-colors text-sm md:text-base block"
                >
                  admin@xai.hk
                </a>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-gray-300">
          <p className="text-sm text-gray-600 font-sans">
            © 2026 70b. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link
              href="/data-privacy-terms"
